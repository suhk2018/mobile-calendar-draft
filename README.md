...
5. 공유 캘린더의 하루를 선택한 뒤 **만난 날로 기록**을 누르면 일정 막대 대신 날짜에 하트가 남습니다.
6. 공유 설정에서 여러 공유 캘린더를 만들거나 초대 코드로 참여할 수 있습니다. 완료되면 해당 캘린더가 바로 열립니다.
7. 왼쪽 목록 아래의 다크 모드 스위치로 화면 테마를 변경합니다.
