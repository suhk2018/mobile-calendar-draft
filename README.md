...
1. 상단에서 **나의 일정** 또는 **함께하는 일정**을 선택합니다.
2. 날짜를 한 번 누르면 해당 날짜의 일정 추가 창이 열립니다.
3. 시작 날짜를 누른 채 마지막 날짜까지 끌면 기간 전체가 선택되고 일정 추가 창이 열립니다.
4. 오른쪽 아래 **+** 버튼으로 현재 선택한 날짜에 일정을 추가할 수도 있습니다.
5. 오른쪽 위 달 모양 버튼으로 화면 테마를 변경합니다.
